...
socket.on('new_question', (q) => {
    ...
    document.getElementById('question-text').innerHTML = q.text; // Changed to innerHTML for LaTeX
    ...
    q.options.forEach((optText, idx) => {
        ...
        btn.innerHTML = optText; // Changed to innerHTML for LaTeX
    ...
    if (typeof MathJax !== 'undefined' && MathJax.typesetPromise) {
        MathJax.typesetPromise([document.getElementById('question-text'), grid]).catch((err) => console.log('MathJax error:', err));
    }
